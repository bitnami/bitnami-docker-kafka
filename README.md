...
### Docker Compose for Most Developers

Most Kafka development stage can be done using one instance of Zookeper and Kafka, here's how to configure one via docker-compose file.
